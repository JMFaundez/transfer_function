...
res1 = ordinary_TF(ys1,zs,z0,times,cond);
res2 = ordinary_TF(ys2,zs,z0,times,cond);
res3 = ordinary_TF(ys1,ys2,z0,times,cond);
res4 = ordinary_TF(ys2,ys1,z0,times,cond);
